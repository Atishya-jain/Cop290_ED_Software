...
void MainWindow::on_pushButton_clicked()
{
    ...
    tmp.p1=tmp2;
     ...
     tmp3.coordinate[2]=0;
     tmp.p2=tmp3;
     input_3d.ModelRotation(ui->coordx->toPlainText().toFloat(),tmp);
     tmp3.coordinate[0]=0;
     tmp3.coordinate[1]=1;
     tmp3.coordinate[2]=0;
     tmp.p2=tmp3;
     input_3d.ModelRotation(ui->coordy->toPlainText().toFloat(),tmp);
     tmp3.coordinate[0]=0;
     tmp3.coordinate[1]=0;
     tmp3.coordinate[2]=1;
     tmp.p2=tmp3;
     input_3d.ModelRotation(ui->coordz->toPlainText().toFloat(),tmp);
